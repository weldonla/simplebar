...
(function(global, factory) {
...
})(this, function(canUseDOM, throttle, resizeObserver) {
  'use strict';
  ...
  canUseDOM =
    canUseDOM && Object.prototype.hasOwnProperty.call(canUseDOM, 'default')
      ...
      : canUseDOM;
  throttle =
    throttle && Object.prototype.hasOwnProperty.call(throttle, 'default')
      ? throttle['default']
      : throttle;
  ...
  // @@match logic
  fixRegexpWellKnownSymbolLogic('match', function(
    MATCH,
    nativeMatch,
    maybeCallNative
  ) {
  ...
  var SimpleBar = /*#__PURE__*/ (function() {
    function SimpleBar(element, options) {
      ...
      this.recalculate = throttle(
        this.recalculate.bind(this),
        this.options.recalculateThrottleWaitTime
      );
    ...
    _proto.initListeners = function initListeners() {
      ...
      var resizeObserver$1 =
        elWindow.ResizeObserver || resizeObserver.ResizeObserver;
